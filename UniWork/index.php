<?php
// UniWork – Public Home Page (Frontend Only)
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
header{
    ...
    align-items:center;
    box-shadow:0 2px 10px rgba(9, 10, 11, 0.69);
}
...
<header>
    <div class="logo">
        <img src="assets/logo uni work.png" alt="UniWork Logo"><b>UniWork</b>
    </div>
    ...
    <div class="hero-inner">
        ...
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                <a href="#" class="btn btn-primary">I'm a Student</a>
                <a href="#" class="btn btn-primary" style="background:#0ea5e9">
                    I'm an Employer
                </a>
            </div>
        </div>
...
<script>
console.log("UniWork Home Loaded");
</script>
